...
public class SjDAO {
	...
	//학생삭제 
	//잘지워지면 1이 반환되고, 잘 안지워지면 0을 반환한다.(정수타입으로 반환된다.)
	//del를 한 수만큼 res가 반환된다(ex) 4명이 지워지면 4가 반환된다.)
	public int delete(int no) {
		...
		try {
			...
			//물음표자리에 넣을 값을 채워 넣는다.
			//물음표 갯수만큼!!
			pstmt.setInt(1, no); //1번째 물음표에 no를 넣는다.
	...
	public int insert(SjVO vo) {
		...
		//DB에서 넣어줄 것은 넣어주고, 그외에는 ?(물음표)로 이후에 값을 넣어줘야한다. 
